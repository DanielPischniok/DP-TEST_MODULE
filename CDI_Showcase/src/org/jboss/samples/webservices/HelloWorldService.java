 ...
 * 2013-11-22T16:40:41.547+01:00
 * Generated source version: 2.6.8.redhat-7
 * 
 */
@WebServiceClient(name = "HelloWorldService", 
                  wsdlLocation = "http://localhost:8080/MDB_Event_Test/HelloWorld?wsdl",
...
public class HelloWorldService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/MDB_Event_Test/HelloWorld?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/MDB_Event_Test/HelloWorld?wsdl");
        }
        WSDL_LOCATION = url;
    }
