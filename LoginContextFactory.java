package de.viada.vhp.junit.base;
...
public class LoginContextFactory {
	...
	static class JAASConfiguration extends Configuration {

		private final String configurationName;

		JAASConfiguration(String configurationName) {
	...
	/**
	 * Obtain a LoginContext configured for use with Arquillian Tests.
	 */
	public static LoginContext createLoginContext(final String username, final String password)
		throws LoginException
	{
		final String configurationName = "Arquillian Testing";
		CallbackHandler cbh = new LoginContextFactory.NamePasswordCallbackHandler(username, password);
		Configuration config = new JAASConfiguration(configurationName);
